    ...
    <form class="ml-4" action="" method="get">
      <div class="flex">
        <div class="from flex">
          ...
          <input type="date" value="<?php if(isset($start_date)) echo $start_date; ?>" name="dateFrom" max="01-01-2050" id="mindate" class="bg-gray-50 border border-gray-300 pl-10 p-2.5 text-gray-900 sm:text-sm rounded-lg" required>
        </div>
        <div class="to flex">

          <h2 class="mx-4">To</h2>
          <input type="date" value="<?php if(isset($end_date)) echo $end_date; ?>" name="dateTo" max="01-01-2050" id="maxdate" class="bg-gray-50 border border-gray-300 pl-10 p-2.5 text-gray-900 sm:text-sm rounded-lg" required>
        </div>
